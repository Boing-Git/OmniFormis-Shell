                                    ...
                                    RowLayout {
                                        ...
                                        Rectangle {
                                            ...
                                            MouseArea {
                                                ...
                                                cursorShape: Qt.PointingHandCursor
                                                hoverEnabled: true
                                                onClicked: rootWifiPage.showPasswordFor(modelData.name)
                                            }
                                        }
                        ...
                        RowLayout {
                            ...
                            Text {
                                ...
                                RotationAnimation {
                                    ...
                                    to: 360
                                    duration: 2000
                                    running: rootWifiPage.wifiDevice && rootWifiPage.wifiDevice.scannerEnabled !== undefined ? rootWifiPage.wifiDevice.scannerEnabled : false
                                    onRunningChanged: if (!running)
                                        wifiScanIcon.rotation = 0
                                }
                            }
                            Text {
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Text {
                        text: "Enter system password to view Wi-Fi credentials for:"
                        font.family: Vars.fontFamily
                        font.pixelSize: 14
                        color: Theme.on_surface
                        Layout.alignment: Qt.AlignHCenter
