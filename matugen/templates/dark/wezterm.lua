return {
    colors = {
        ...
        cursor_bg = "{{colors.on_surface.dark.hex}}",
        cursor_border = "{{colors.on_surface.dark.hex}}",
        cursor_fg = "{{colors.on_surface_variant.dark.hex}}",
        selection_bg = "{{colors.secondary_fixed_dim.dark.hex}}",
        selection_fg = "{{colors.on_secondary.dark.hex}}",
        split = "{{colors.secondary_fixed_dim.dark.hex}}",
        ansi = {
